...
namespace Carbon.Networking.Icmp
{
	...
	{	
		...
		public event EventHandler<PingerEventArgs> PingStarted;
		public event EventHandler<PingerResultEventArgs> PingResult;
        public event EventHandler<PingerStatisticsEventArgs> PingStatistics;
