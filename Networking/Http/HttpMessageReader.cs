...
//		private HttpHeaderList		_headers;
		...
		/// <returns></returns>
        public virtual HttpMessage Read(Socket socket, ManualResetEvent abortEvent, EventHandler<HttpMessageProgressEventArgs> onProgress, object stateObject)
		{
			if (socket == null)
		...
		/// </summary>
        private void ProcessData(ManualResetEvent abortEvent, ref HttpMessage message, EventHandler<HttpMessageProgressEventArgs> onProgress, object stateObject)
		{
