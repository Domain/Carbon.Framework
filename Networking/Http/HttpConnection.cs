...
namespace Carbon.Networking.Http
{
	...
	{				
		...
		public event EventHandler<HttpConnectionEventArgs> Opened;
        public event EventHandler<HttpConnectionEventArgs> Closed;
...
//                    Debug.WriteLine(e.Response.GetBodyAsString(HttpUtils.Encoding));
		...
		public virtual void SendRequest(
			HttpRequest request,			
			EventHandler<HttpMessageProgressEventArgs> onProgress,
			object stateObject)
		{
