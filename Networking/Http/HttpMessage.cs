...
namespace Carbon.Networking.Http
{
	...
	{						
		...
		internal protected HttpHeaderCollection _headers;
		...
		public HttpMessage(string firstLine, HttpHeaderCollection headers)
		{			
		...
		public HttpMessage(string firstLine, HttpHeaderCollection headers, byte[] body)
		{			
			_firstLine = firstLine;
			_headers = headers;
			this.Body = body;
